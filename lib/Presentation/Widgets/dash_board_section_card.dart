...
class DashboardSectionCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      margin: const EdgeInsets.symmetric(horizontal: kDefaultPadding, vertical: 8),
          ...
          children: [
            ...
            Row(
              children: [
                ...
                Text(
                  title!,
                  style: TextStyle(color: Colors.white,fontWeight: FontWeight.w700,fontSize: 16,fontFamily: "Montserrat"), // Use theme text style
                ),
              ],
            ),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text(buttonText!,style: TextStyle(color: Colors.black,fontWeight: FontWeight.w700,fontSize: 16,fontFamily: "Montserrat")),
                      const SizedBox(width: 8),
